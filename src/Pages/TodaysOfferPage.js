              ...
              <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
                ...
                <div className="lg:col-span-3">
                  ...
                  <div className=" w-full flex justify-center py-7">
                    <div className="First_cart grid 2xl:gap-4 2xl:grid-cols-4 grid-cols-1 gap-4 md:grid-cols-2  sm:grid-cols-2  lg:grid-cols-2 xl:grid-cols-3  ">
                      {selectOptions.map((value, index) => {
                        return (
                          <div
                            onClick={() => {
                              Navigate(
                                `/collectionsdaily-deals/${value.category}/${value.id}`
                              );
                            }}
                            key={index}
